...
void main() {
  ...
  group('HomeRepository Tests', () {
    ...
    test(
      'When call createAlias with invalid response should throw Exception',
      () async {
        // Arrange
        const url = 'https://www.example.com';
    ...
    test(
      'When call createAlias with network error should throw Exception',
      () async {
        // Arrange
        const url = 'https://www.example.com';
    ...
    test(
      'When call createAlias with status 200 should return UrlAliasModel',
      () async {
        // Arrange
        const url = 'https://www.example.com';
    ...
    test(
      'When call createAlias with HttpException should throw Exception',
      () async {
        // Arrange
        const url = 'https://www.example.com';
    ...
    test(
      'When call createAlias with generic exception should throw Exception',
      () async {
        // Arrange
        const url = 'https://www.example.com';
    ...
    test(
      'When HomeRepository is created without httpClient should use default',
      () {
        // Act
